...
import com.bootsystem.controllers.UniteJpaController;
...
public class UniteController implements Serializable {
    ...
    private Unite current;
    private DataModel items = null;
    private UniteJpaController jpaController = null;
    ...
    private UniteJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new UniteJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getUniteCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findUniteEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getUniteCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findUniteEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findUniteEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findUniteEntities(), true);
    }
    ...
    public static class UniteControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findUnite(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Unite) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Unite.class.getName());
            }
        }
